            ...
            <form name="insertrecord" method="post">
                <div class="row">
                    <div class="col-md-4"><b>First Name</b>
                        <input type="text" name="f_name" value="<?php echo htmlentities($result->f_name); ?>" class="form-control" required>
                    </div>
                    <div class="col-md-4"><b>Last Name</b>
                        <input type="text" name="l_name" class="form-control" value="<?php echo htmlentities($result->l_name); ?>" required>
                    </div>
                </div>
                <div class="row">
